...
function fnProfileAddWallBookmarkSelector() {
	...
	var selectorHTML = '<select name=sel onchange="alert(\"hi\");if (this.options[this.options.selectedIndex].value!=0) window.location=\"/en/ios/friends/profile?pid=\"+(this.options[this.options.selectedIndex].value);"><option selected value="0">---';

...
function fnForkRoad() {
	...
	var autoSetFormationHTML = '<br/><input type="button" value="Auto Set Event Team" onClick="alert(\'a\');fnAutoSetEventFormation();alert(\'b\');fnRedirect(\'/en/'+platform+'/forkroad\');alert(\'a\');"><br/><br/>';

...
function fnDungeon() {
	...
	var bpSelectorHTML =  'Auto BP<select name="bp" onchange="fnSetDungeonAutoBP(this.options[this.options.selectedIndex].value]);fnGrowl(\'Auto BP:\'+this.options[this.options.selectedIndex].text);"><option ' + (fnDungeonAutoBP()==0?'selected':'') + ' value="0">Auto Off</option><option ' + (fnDungeonAutoBP()==3003?'selected':'') + ' value="3003">Real BP</option><option ' + (fnDungeonAutoBP()==3019?'selected':'') + ' value="3019">My BP</option></select>';	

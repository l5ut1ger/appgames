...
function fnProfileAddWallBookmarkSelector() {
	...
	var selectorHTML = '<select name="sel" onchange="alert(this.options[this.options.selectedIndex].value);if (this.options[this.options.selectedIndex].value!=0) window.location=\"/en/ios/home\";"><option selected value="0">---';

...
function fnFriend() {
	...
	divTag.innerHTML = '<button class="sexybutton sexysmall sexysimple sexyblue" onmousedown="confirm(\'Are you sure you want to remove all ally?\')?2:0">Remove All Ally</button>'; 
	document.body.appendChild(divTag); 

...
function fnPresentBox() {
	...
	if (document.getElementById('button_fp_ng') != null) {
		...
		divTag.style["z-index"] = 1000; 
		divTag.style.position = "relative"; 
		divTag.innerHTML = '<button class="sexybutton sexysimple sexyblue" onmousedown="for (var i=0;i<player.boxes.length;i++){onReceive(null, player.boxes[i]);}"><span class="download2">Receive All</span></button>'; 

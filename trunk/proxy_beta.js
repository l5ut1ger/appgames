...
function fnDungeon() {
	...
	var levelSelectorHTML = '<button class="sexybutton sexysmall sexysimple sexyblue" onmousedown="javascript:setTimeout(function(){$.redirect(\'/en/ios/dungeon/win?area_id=1&tribe=2\');}, 1000);">NextMission</button><select style="top:-20px"  onchange="fnSetDungeonTravelLevel(this.options[this.options.selectedIndex].value);fnGrowl(this.options[this.options.selectedIndex].text);">';
	...
	document.getElementById('deck_bg').innerHtml += 'afdasdf'+levelSelectorHTML + expSelectorHTML + goldSelectorHTML;
	document.getElementById('deck_bg').style.height="300px";
